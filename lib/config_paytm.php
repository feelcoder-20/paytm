...
define('CALLBACK_URL', 'xxxxxxx'); //use your website url where paytm return payment response like this -> http://your_website_url/how-to-integrate-paytm-payment-gateway-in-php-with-demo-download/TxnStatus.php"
